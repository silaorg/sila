...
Find the obviously stupid parts: hacks, brittle special cases, duplicated flows, dead helpers, confusing names, needless indirection, fake abstractions, and anything that exists only because nobody stopped to clean it up.
...
End with a summary of what was dumb, what changed, and what still smells.