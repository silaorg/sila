...
- `packages/heswe/src/channels/slack-channel.js`
  - Slack auth and event handlers
  - thread id resolution
  - attachment normalization
  - outbound Slack send
- `packages/heswe/src/channels/telegram-channel.js`
  - same shape as Slack, but for Telegram
- `packages/heswe/src/channels/threaded-channel-runtime.js`
...
Introduce a shared runtime layer in `packages/heswe/src/channels/` that owns the common thread flow.
...
Introduce a small thread store abstraction in `packages/agents/src/` or `packages/heswe/src/channels/`.
