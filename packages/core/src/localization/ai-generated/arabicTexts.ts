...
export const arabicTexts: Partial<Texts> = {
  ...
  wizards: {
    ...
    spaceSetupSearchTitle: "إعداد البحث لمساحة العمل (اختياري)",
    spaceSetupSearchDescription: "اربط مزود بحث لتمكين مساعديك من البحث في الويب. هذا اختياري ويمكنك تخطيه الآن.",
    spaceSetupSearchStepTitle: "البحث",
