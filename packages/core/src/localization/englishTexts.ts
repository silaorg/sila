...
export const englishTexts: Texts = {
  ...
  modelProviderSetup: {
    ...
    kimi: "You will need to enter a key that will allow you to use Kimi's models.\n\n1. Sign up or log in at [platform.moonshot.ai](https://platform.moonshot.ai/).\n2. Open the [Developer Console](https://platform.moonshot.ai/) and create a new API key.\n3. Paste the key and wait for it to validate.",
