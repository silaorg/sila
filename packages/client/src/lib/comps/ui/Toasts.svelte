<script lang="ts">
  // @TODO: at the moment the toast function works with toastState that is signletone,
  // we try not to use signletones in Sila and instead pack everything in
